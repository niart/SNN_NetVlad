...
A spiking VGG attached NetVlad layer is trained with Backpropagation Through Time (BPTT) to recognize 16 classes of indoor visual scenes in an artificial office environment, and tested for generalization on three additional unseen places. Download our dataset **[HERE](https://drive.google.com/drive/folders/1oC8KnzzZXLAF_QzLBpGEebBqCXU_yTTT?usp=sharing)**. 
